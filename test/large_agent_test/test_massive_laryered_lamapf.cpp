...
int main() {
    ...
    std::vector<std::tuple<SingleMapTestConfig<2>, int, int, int, int> >
        ...
        {MAPFTestConfig_AR0044SR, 1, 20, 2, 2}, // 50, 5, 5 // in pub
        {MAPFTestConfig_AR0203SR, 1, 20, 2, 2}, // 40, 5, 5 // in pub

    // //
        {MAPFTestConfig_den520d,         5, 20, 2, 2},// 10, 60, 5, 5 // in pub

      //{MAPFTestConfig_AR0072SR, 1, 30, 5, 5}, // 30, 5, 5

        {MAPFTestConfig_Paris_1_256,     10, 20, 2, 2}, // 80, 10, 10 / 20, 2, 2s // in pub
