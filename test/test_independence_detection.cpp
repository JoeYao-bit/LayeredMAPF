//
// Created by yaozhuo on 2024/12/16.
//
...
//    multiple_paths = layeredMAPF<2>(ists, dim, is_occupied, MAPF_func, LaCAM2::lacam2_MAPF, false, 30);
    ...
    std::cout << "ID total cost          = " << total_cost << std::endl;
    std::cout << "ID maximum_single_cost = " << maximum_single_cost << std::endl;
    std::cout << "** max_size_of_stack_ID = " << max_size_of_stack_layered << " **" << std::endl;
