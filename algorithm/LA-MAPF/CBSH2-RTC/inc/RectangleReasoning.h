...
// no rectangle, rectangle, rectangle with MDDs, generalized rectangle, disjoint rectangle
    ...
    public:
        ...
        void printOverlapArea(const vector<Path *> &paths, int conflict_timestep,
                              int a1, int a2, const MDD *mdd1, const MDD *mdd2) {
    ...
    private:
        ...
        shared_ptr<Conflict> findRectangleConflict(const vector<Path *> &paths, int timestep, int a1,
                                                   int a2) { // R: find rectangle only for entire paths
        ...
        shared_ptr<Conflict> findRectangleConflict(const vector<Path *> &paths, int timestep,
                                                   ...
                                                   const MDD *mdd2) {  // RM: find rectangle for path segments
            shared_ptr<Conflict> rectangle = nullptr;
        ...
        void findOverlapArea(int conflict_location, vector<bool> &overlap_area,
                             ...
                             set<pair<int, int> > &entry1, set<pair<int, int> > &entry2, list<int> &exit1,
                             list<int> &exit2,
        ...
        list<Constraint> generateConstraint(const vector<bool> &overlap_area,
                                            const vector<MDDNode *> &visit_times, int agent, const pair<int, int> &from,
                                            const pair<int, int> &to) const {
