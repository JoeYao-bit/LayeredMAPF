#include "../inc/MutexReasoning.h"
#include "../inc/ConstraintPropagation.h"
...
namespace freeNav::LayeredMAPF::LA_MAPF::CBSH2_RTC {
    ...
    void
    MutexReasoning::cache_constraint(ConstraintsHasher &c1, ConstraintsHasher &c2, shared_ptr<Conflict> constraint) {
