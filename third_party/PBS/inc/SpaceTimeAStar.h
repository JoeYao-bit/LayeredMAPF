...
namespace PBS_Li {
    ...
    public:
        ...
        typedef boost::heap::pairing_heap<AStarNode *, boost::heap::compare<LLNode::compare_node> >::handle_type open_handle_t;
        typedef boost::heap::pairing_heap<AStarNode *, boost::heap::compare<LLNode::secondary_compare_node> >::handle_type focal_handle_t;
    ...
    public:
        ...
        CBS_Li::MAPFPath findOptimalPath(const std::set<int> &higher_agents,
                                 const std::vector<CBS_Li::MAPFPath *> &paths, int agent,
                                 const CBS_Li::ConstraintTable &initial_constraints) override;

        std::string getName() const override { return "AStar"; }

        SpaceTimeAStar(const CBS_Li::Instance &instance, int agent) :
    ...
    private:
        ...
        static void updatePath(const LLNode *goal, std::vector<CBS_Li::PathEntry> &path);
