#include "CBSH2-RTC/inc/CorridorReasoning.h"
#include "CBSH2-RTC/inc/Conflict.h"
#include <memory>
...
// the version in the paper
    ...
    pair<int, int> CorridorReasoning::getTimeRanges(int a1, int a2, int endpoint1, int endpoint2,
                                                    int from1, int from2, int lowerbound1, int lowerbound2,
                                                    int corridor_length, const CBSNode &node) {
