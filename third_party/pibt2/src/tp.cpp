...
namespace PIBT_2 {
    ...
    void TP::run() {
        std::vector<path_pathfinding::Path> TOKEN(P->getNum());
        Agents A;
    ...
    void TP::updatePath1(int i, Task *task, std::vector<path_pathfinding::Path> &TOKEN) {
    ...
    void TP::updatePath2(int i, std::vector<path_pathfinding::Path> &TOKEN, Tasks &unassigned_tasks) {
    ...
    void TP::updatePath(int i, Node *g, std::vector<path_pathfinding::Path> &TOKEN) {
