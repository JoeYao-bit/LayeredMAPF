...
// yz: clear all current hyper node conflicts
    void HLNode::clear() {
        conflicts.clear();
        unknownConf.clear();
        // conflictGraph.clear();
...
// yz: distance to goal is number of conflicts + number of conflict agent in current HLNode
    void HLNode::updateDistanceToGo() {
        set<pair<int, int>> conflicting_agents; // yz: how many pairs of agent have conflict in current HLNode
