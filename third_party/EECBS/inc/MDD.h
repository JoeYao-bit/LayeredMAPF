...
// yz: Multi-Valued Decision Diagram, what is is
    class MDDNode {
    public:
    ...
    public:
        ...
        MDDTable(const ConstraintTable &static_constraint_o,
                //const vector<ConstraintTable>& initial_constraint,
    ...
    private:
        ...
        // yz: each agent have a Multi Value Decision Table
        ...
        const vector<SingleAgentSolver *> &search_engines; // yz: multiple single agent solver
