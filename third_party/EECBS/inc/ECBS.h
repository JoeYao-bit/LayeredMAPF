...
namespace CBS_Li {
    ...
    public:
        ECBS(const Instance &instance, const ConstraintTable &static_constraint, bool sipp, int screen) : CBS(instance,
                                                                                                              static_constraint,
                                                                                                              sipp,
                                                                                                              screen) {}
    ...
    private:
        ...
        void computeConflictPriority(std::shared_ptr<Conflict> &con, ECBSNode &node);
